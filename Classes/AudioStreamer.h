...
//
//  Modified by Eponymous Applications.
//  Copyright Eponymous Applications, LLC 2010.  All rights reserved.
//
...
#define kNumAQBufs 20			// Number of audio queue buffers we allocate.
